    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
      ...
      builder.Entity<Park>()
        .HasData(
          ...
          new Park { ParkId = 2, Name = "Crater Lake", ParkType = "National", HasRestrooms = "Unknown" },
          ...
          new Park { ParkId = 7, Name = "Lake Clark", ParkType = "National", HasRestrooms = "Unknown" },
          ...
          new Park { ParkId = 22, Name = "Port Orford Heads", ParkType = "State", HasRestrooms = "Unknown" },
          ...
          new Park { ParkId = 25, Name = "Guadalupe Mountains", ParkType = "National", HasRestrooms = "Unknown" }
        );
    }
  }
}